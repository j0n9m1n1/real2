...
public class ReportDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView dead = (TextView)findViewById(R.id.report_dead);
        ...
        dead.setText   ("마감일 : "+ReportActivity.DataList.get(groupposition).reportgroup.get(childposition).reportdetail.get(3));
